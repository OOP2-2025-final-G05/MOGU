...
- お店一覧画面
> 「お店名、住所、価格帯、評価、編集ボタン、レビューボタン」を表示。お店の名前を押したら「お店詳細」に遷移。編集ボタンを押すと「編集」画面に遷移する。レビューボタンを押すと「レビュー」画面に遷移する。
![](restaurant_list_image.png)
 
- お店詳細画面
> 「お店名、住所、ジャンル、価格帯、営業時間」「コメント、評価、年齢、性別、投稿日」を表示。スクロールして複数のレビューを閲覧できる。
